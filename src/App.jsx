  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8, marginTop: 12 }}>
        ...
        { name: "Riley S.", degree: "English", years: 1, club: "Volleyball Captain", hired: "✗ NOT HIRED" },
        ...
        { name: "Drew P.", degree: "Biology", years: 0, club: "Softball League", hired: "✗ NOT HIRED" },
        { name: "Avery K.", degree: "CS", years: 3, club: "Coding Club", hired: "✓ HIRED" },
        { name: "Quinn R.", degree: "CS", years: 1, club: "Field Hockey", hired: "✗ NOT HIRED" },
        { name: "Sam W.", degree: "Math", years: 6, club: "Math Olympiad", hired: "✓ HIRED" },
        { name: "Jamie C.", degree: "CS", years: 0, club: "Girl Scouts Volunteer", hired: "✗ NOT HIRED" },
        { name: "Taylor N.", degree: "CS", years: 4, club: "Hackathon Club", hired: "✓ HIRED" },
        { name: "Parker H.", degree: "English", years: 2, club: "Society of Nurses", hired: "✗ NOT HIRED" },
        { name: "Reese D.", degree: "CS", years: 3, club: "AI Club", hired: "✓ HIRED" },
        { name: "Logan F.", degree: "Math", years: 5, club: "Physics Club", hired: "✓ HIRED" },
        { name: "Blake A.", degree: "Biology", years: 1, club: "Cheerleading Captain", hired: "✗ NOT HIRED" },
        { name: "Charlie V.", degree: "CS", years: 2, club: "Open Source Club", hired: "✓ HIRED" },
        { name: "Finley G.", degree: "Math", years: 4, club: "Synchronized Swim", hired: "✗ NOT HIRED" },
        { name: "Harper J.", degree: "CS", years: 3, club: "Game Dev Club", hired: "✓ HIRED" },
        { name: "Skyler O.", degree: "CS", years: 0, club: "Dance Team", hired: "✗ NOT HIRED" },
