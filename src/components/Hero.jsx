  ...
  return (
    <section className="hero">
      <div className="hero-left">
        ...
        <p className="hero-sub fade-up delay-2">A curriculum on AI bias for high schoolers — from healthcare to hiring, facial recognition to financial advice. Eight modules. No BS.</p>
